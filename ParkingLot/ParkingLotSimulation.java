 ...
 * This is an abstract base class for different spot types.
 */
abstract class ParkingSpot {
    private String spotId;
    private ParkingSpotType spotType;
    private ParkingStatus status;
    private String vehicleId; // ID of the vehicle currently occupying the spot
...
/**
 * Represents a compact parking spot.
 */
...
/**
 * Represents a large parking spot.
 */
...
/**
 * Represents a motorcycle parking spot.
 */
...
/**
 * Represents an electric vehicle charging spot.
 */
 ...
 * Contains information about entry time, spot, and vehicle.
 */
class Ticket {
...
/**
 * Abstract base class for Entry and Exit terminals.
 */
abstract class Terminal {
    protected String terminalId;
    protected ParkingLot parkingLot; // Reference to the main parking lot system
...
/**
 * Handles vehicle entry, issues tickets, and assigns parking spots.
 */
class EntryTerminal extends Terminal {
    ...
    /**
     * Issues a ticket and attempts to find a parking spot.
     * @param vehicleId The ID of the entering vehicle.
     * @param vehicleType The type of the entering vehicle.
     * @return The ticket if successful, null otherwise.
     */
...
/**
 * Handles vehicle exit, processes payment, and frees parking spots.
 */
class ExitTerminal extends Terminal {
    ...
    /**
     * Processes the exit of a vehicle using its ticket.
     * Calculates fee and simulates payment.
     * @param ticketId The ID of the ticket for the exiting vehicle.
...
/**
 * The main Parking Lot system.
 * Manages parking spots, tickets, and terminals.
 * This class is now implemented as a Singleton pattern.
 */
class ParkingLot {
    ...
    private Map<String, ParkingSpot> spotMap; // Maps spot_id to ParkingSpot object for quick lookup
    ...
    /**
     * Static method to get the single instance of the ParkingLot.
     * If the instance does not exist, it creates it.
     * @param name The name of the parking lot (used only for initial creation).
     * @param hourlyRate The hourly rate for parking (used only for initial creation).
     * @return The single instance of the ParkingLot.
     */
    ...
    /**
     * Finds a suitable free spot for the given vehicle type and assigns it.
     * Prioritizes smaller spots if applicable.
     * @param vehicleId The ID of the vehicle.
     * @param vehicleType The type of the vehicle.
     * @return The assigned ParkingSpot object if found, null otherwise.
     */
    ...
    /**
     * Frees a specific parking spot by its ID.
    ...
    /**
     * Prints the current status of all parking spots.
     */
    ...
    /**
     * Prints the status of all active tickets.
     */
...
class ParkingLotSimulation {
    public static void main(String[] args) {
        ...
        ParkingLot myParkingLot = ParkingLot.getInstance("City Center Parking", 3.00);
